...
public class ChannelCacheUtil {
    ...
    //创建缓存
    private static final LoadingCache<String, HttpMsgHandler.ChannelCache> cache = Caffeine.newBuilder()
...
//			.maximumSize(10240)
     ...
     * 获取数据
     */
    public static HttpMsgHandler.ChannelCache get(String channelId) {
     ...
     * 存入数据
     */
    public static void put(String channelId, HttpMsgHandler.ChannelCache channelCache) {
